    ...
    return (
        <section className="section-center">
            <form className="grocery-form" onSubmit={handleSubmit}>
                {alert.show && <GroceryAlert {...alert} removeAlert={showAlert} list={list}/>}
                <h3>grocery bud</h3>
                <div className="form-control">
                    <input type="text" className="grocery" value={name} onChange={(event)=>{
            ...
            {list.length>0 &&   <div className="grocery-container">
                <GroceryList props={list} removeItem={removeItem} editItem={editItem}/>
