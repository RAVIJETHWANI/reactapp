...
import Loading from "./CocktailLoading";
...
/*const SingleCocktail=()=>{
            ...
            try{
                ...
                if(data.drinks){
                    const {
                      ...
                      const newCocktail ={name,image,info,category,glass,instructions}
    ...
    const {name,image,info,category,glass,instructions}=cocktails
    return(
